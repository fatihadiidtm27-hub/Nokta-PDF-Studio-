// ============================================================
// NOKTA SUITE — AUTH GATE (verifikasi kode via GitHub Gist)
// ------------------------------------------------------------
// File ini SAMA PERSIS dengan auth-gate.js di NOKTA Clip, dan
// sengaja memakai gist codes.json yang SAMA — supaya satu kode
// akses yang sama bisa dipakai untuk membuka semua tools NOKTA
// (Clip, Reframe, dan tools berikutnya).
//
// Kalau nanti mau kode Reframe terpisah dari Clip, cukup ganti
// CODES_GIST_URL di bawah ke gist baru khusus Reframe.
// ============================================================
...
(() => {
  ...
  gate.innerHTML = `
    <div class="gate-box">
      ...
      <h1>NOKTA // PDF STUDIO</h1>
      <p>Masukkan kode akses NOKTA kamu untuk membuka aplikasi ini.</p>
  ...
  function saveKey(key){ try{ localStorage.setItem(STORAGE_KEY, key); }catch(e){} }
  function loadSavedKey(){ try{ return localStorage.getItem(STORAGE_KEY); }catch(e){ return null; } }
